...
public class Generator {
	...
	public static void runSine(int throughput, int duration) throws InterruptedException {
		...
		while(System.currentTimeMillis() < endTime) {
			...
			// send messages at configured throughput
			sendTime = sendTime + (long) (sendTime + Math.sin(Math.floor(2*3.1415 / throughput)) + 1);
